...
namespace io.github.kiriumestand.multiplefieldbulkchanger.editor
{
            ...
            ((IExpansionInspectorCustomizer)this).Subscribe<SelectObjectSerializedPropertiesUpdateEventArgs>(this,
                ...
                e =>
                {
                    ...
                    if (e.SenderInspectorCustomizerSerializedProperty != null)
                    {
                        ...
                        else if (senderPropertyTypeName == $"managedReference<{nameof(MultipleFieldSelectorContainer)}>")
                        {
                            SerializedProperty senderDescendantProperty = senderDrawerProperty.SafeFindPropertyRelative(nameof(MultipleFieldSelectorContainer._FieldSelectors));
                            if (senderDescendantProperty == null) return false;
    ...
    [CustomPropertyDrawer(typeof(FieldSelector))]
    public class FieldSelectorDrawerImpl_new : ExpansionPropertyDrawerImpl<FieldSelectorDrawer>
    {
        public FieldSelectorDrawerImpl_new() : base() { }

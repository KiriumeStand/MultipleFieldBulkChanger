...
namespace io.github.kiriumestand.multiplefieldbulkchanger.editor
{
    ...
    public class ArgumentSettingDrawerImpl_new : ExpansionPropertyDrawerImpl<ArgumentSettingDrawer>
    {
        ...
        public ArgumentSettingDrawerImpl_new() : base() { }
        ...
        )
        {
            ...
            if (argumentName.HasValue && argumentData.Name != argumentName.Value)
            {
                argumentData.Name = argumentName.Value;
                nameChanged = true;
            }
            if (argumentType.HasValue && argumentData.Type != argumentType.Value)
            {
                argumentData.Type = argumentType.Value;
                typeChanged = true;
            }
